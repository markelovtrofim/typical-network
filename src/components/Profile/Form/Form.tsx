...
import {PagLeftArrowSvg} from "../../common/Svg";
        ...
        <div>
            <form onSubmit={props.handleSubmit}>
                ...
                <div className={styles.buttons_box}>
                    <span className={styles.back} onClick={() => props.setEditMode(false)}><PagLeftArrowSvg width={15} height={15}/></span>
            ...
            <div className={styles.inner}>
                <div className={styles.item}>
                    ...
                    <div className={styles.img}>
                        <Avatar img={props.profile.data.photos.large ? props.profile.data.photos.large : defaultUserImage} width={150} height={150}/>
                    </div>
                </div>
                <AboutFormRedux setEditMode={props.setEditMode} profile={props.profile} initialValues={props.profile.data}
                                // @ts-ignore
                                onSubmit={onsubmit}/>
            </div>
        </div>
